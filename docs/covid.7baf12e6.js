...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../static/us-states.csv":[function(require,module,exports) {
module.exports = "/us-states.1be96b49.csv";
},{}],"javasript/covid.js":[function(require,module,exports) {
"use strict";
...
function drawLineVegaLite() {
  var layer1 = plot('cases').width(600).height(225).title("Cumulative Covid-19 Case Counts");
  var layer2 = plot('deaths').width(600).height(225).title("Cumulative Covid-19 Death Counts");
...
function drawLineVegaLite() {
  ...
  var cases = vl.markLine({
    ...
    title: 'Cases'
  }).fieldQ('cases')).width(600).height(225).title("Cumulative Covid-19 Case Counts");
  var casetip = vl.markRule({
    color: "#aaa"
  }).select(hover).transform(vl.filter(selection)).encode(vl.opacity().if(hover, vl.value(1)).value(0), vl.tooltip().fieldT('date'));
  var casepoints = vl.markCircle({
    size: 30
  }).transform(vl.filter(selection)).encode(vl.y().fieldQ('cases'), vl.opacity().if(hover, vl.value(1)).value(0));
  var case_text = vl.markText(label).transform(vl.filter(selection)).encode(vl.y().fieldQ('cases'), vl.opacity().if(hover, vl.value(1)).value(0), vl.text().fieldQ('cases'));
  ...
  var death = vl.markLine({
    ...
    title: 'Deaths'
  }).fieldQ('deaths')).width(600).height(225).title("Cumulative Covid-19 Death Counts");
  var deathTip = vl.markRule({
    color: "#aaa"
  }).select(hover).transform(vl.filter(selection)).encode(vl.opacity().if(hover, vl.value(1)).value(0), vl.tooltip().fieldT('date'));
  var death_points = vl.markCircle({
    size: 30
  }).transform(vl.filter(selection)).encode(vl.y().fieldQ('deaths'), vl.opacity().if(hover, vl.value(1)).value(0));
  var death_text = vl.markText(label).transform(vl.filter(selection)).encode(vl.y().fieldQ('deaths'), vl.opacity().if(hover, vl.value(1)).value(0), vl.text().fieldQ('deaths'));
...
},{"../../static/us-states.csv":"../static/us-states.csv"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","javasript/covid.js"], null)
//# sourceMappingURL=/covid.7baf12e6.js.map